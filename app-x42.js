// SpoofProof — app-x42.js — v0.1.10
// Fix: init runs whether DOM is ready or not; no timing race with DOMContentLoaded.
// Robust Int’l toggle, US formatting, entries, simulator, logs.
...
(function(){
  ...
  function init() {
    ...
    // Helpers / storage
    const K = 'spfp_k1'; const L = 'spfp_log1';
    ...
    console.log('app-x42.js loaded v0.1.10');
  }
